...
reg4 <- lm(rating ~ gender + nb_experiences + nb_educations +NumberofMatches+
             nb_recommendations_with_text + nb_likes  + profile_age_years +  match_type,#preferred_family +
           data = combined)
summary(reg4)
reg8 <- lm(rating ~ gender + nb_experiences + nb_educations +NumberofMatches+
             nb_recommendations_with_text + nb_likes  + profile_age_years +  match_type,#preferred_family +
           data = combined)
summary(reg8)
#######################
...
mod_matches_tbl <- lm(
  NumberofMatches ~ gender + nb_experiences + nb_educations +
    nb_recommendations_with_text + nb_likes + rating,
  data = combined
)
